...
public class ListJobExecutionListener implements JobExecutionListener {
	...
	public void beforeJob(JobExecution jobExecution) {
		...
		jobExecution.getExecutionContext().putString("restart", "false");
	...
	public void afterJob(JobExecution jobExecution) {
		...
		logger.debug("JOB BATCH STATUS " + jobExecution.getStatus() + " JOB EXIT STATUS "
				+ jobExecution.getExitStatus());
		if (executionContext.getString("restart").equals("false")) {
